...
# Usage: qsub -v "args_b64=<base64 runner args>,tps_eval_root=<repo>" proteinmpnn_score.sh
...
# PBS Pro port of scripts/karolina/jobs/proteinmpnn_score.sh (calls run_proteinmpnn_score.sh).
