#!/bin/bash
#PBS -N foldseek_swissprot_search
#PBS -l walltime=04:00:00
#PBS -l select=1:ncpus=16:mem=32gb:scratch_local=20gb

# Usage: qsub -v "args_b64=<base64 runner args>,tps_eval_root=<repo>" foldseek_swissprot_search.sh
...
# PBS Pro port of scripts/karolina/jobs/foldseek_swissprot_search.sh (calls run_foldseek_swissprot_search.sh).
...
echo "Calling run_foldseek_swissprot_search.sh with args: $args"
sh tool_wrappers/run_foldseek_swissprot_search.sh $args
