#!/bin/bash
#PBS -N diphosphate_sensor
#PBS -l walltime=01:00:00
#PBS -l select=1:ncpus=4:mem=16gb:scratch_local=4gb

# Usage: qsub -v "args_b64=<base64 runner args>,tps_eval_root=<repo>" diphosphate_sensor.sh
...
# PBS Pro port of scripts/karolina/jobs/diphosphate_sensor.sh (calls run_diphosphate_sensor.sh).
