#!/bin/bash
#PBS -N motif_pair_distance
#PBS -l walltime=00:10:00
#PBS -l select=1:ncpus=1:mem=16gb:scratch_local=2gb

# Usage: qsub -v "args_b64=<base64 runner args>,tps_eval_root=<repo>" motif_pair_distance.sh
...
# PBS Pro port of scripts/karolina/jobs/motif_pair_distance.sh (calls run_motif_pair_distance.sh).
...
echo "Calling run_motif_pair_distance.sh with args: $args"
sh tool_wrappers/run_motif_pair_distance.sh $args
