#!/bin/bash
#PBS -N aromatic_lining
#PBS -l walltime=01:00:00
#PBS -l select=1:ncpus=4:mem=16gb:scratch_local=4gb

# Usage: qsub -v "args_b64=<base64 runner args>,tps_eval_root=<repo>" aromatic_lining.sh
...
# PBS Pro port of scripts/karolina/jobs/aromatic_lining.sh (calls run_aromatic_lining.sh).
