#!/bin/bash
#PBS -N interdomain_pae
#PBS -l walltime=06:00:00
#PBS -l select=1:ncpus=20:mem=32gb:scratch_local=10gb

# Usage: qsub -v "args_b64=<base64 runner args>,tps_eval_root=<repo>" interdomain_pae.sh
...
# PBS Pro port of scripts/karolina/jobs/interdomain_pae.sh (calls run_interdomain_pae.sh).
