#!/bin/bash
#PBS -N domain_composition
#PBS -l walltime=06:00:00
#PBS -l select=1:ncpus=20:mem=32gb:scratch_local=10gb

# Usage: qsub -v "args_b64=<base64 runner args>,tps_eval_root=<repo>" domain_composition.sh
...
# PBS Pro port of scripts/karolina/jobs/domain_composition.sh (calls run_domain_composition.sh).
