#!/bin/bash
#PBS -N sdr_divergence
#PBS -l walltime=01:00:00
#PBS -l select=1:ncpus=4:mem=16gb:scratch_local=4gb

# Usage: qsub -v "args_b64=<base64 runner args>,tps_eval_root=<repo>" sdr_divergence.sh
...
# PBS Pro port of scripts/karolina/jobs/sdr_divergence.sh (calls run_sdr_divergence.sh).
