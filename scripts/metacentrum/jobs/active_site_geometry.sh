#!/bin/bash
#PBS -N active_site_geometry
#PBS -l walltime=01:00:00
#PBS -l select=1:ncpus=4:mem=16gb:scratch_local=4gb

# Usage: qsub -v "args_b64=<base64 runner args>,tps_eval_root=<repo>" active_site_geometry.sh
...
# PBS Pro port of scripts/karolina/jobs/active_site_geometry.sh (calls run_active_site_geometry.sh).
