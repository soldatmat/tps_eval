#!/bin/bash
#PBS -N substrate_class
#PBS -l walltime=00:30:00
#PBS -l select=1:ncpus=4:mem=16gb:scratch_local=4gb

# Usage: qsub -v "args_b64=<base64 runner args>,tps_eval_root=<repo>" substrate_class.sh
...
# PBS Pro port of scripts/karolina/jobs/substrate_class.sh (calls run_substrate_class.sh).
...
echo "Calling run_substrate_class.sh with args: $args"
sh tool_wrappers/run_substrate_class.sh $args
