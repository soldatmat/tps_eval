...
# Usage: qsub -v "args_b64=<base64 runner args>,tps_eval_root=<repo>" soluprot.sh
...
# PBS Pro port of scripts/karolina/jobs/soluprot.sh (calls run_soluprot.sh).
...
echo "Calling run_soluprot.sh with args: $args"
sh tool_wrappers/run_soluprot.sh $args
