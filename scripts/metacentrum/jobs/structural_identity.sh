#!/bin/bash
#PBS -N structural_identity
#PBS -l walltime=04:00:00
#PBS -l select=1:ncpus=16:mem=32gb:scratch_local=20gb

# Usage: qsub -v "args_b64=<base64 runner args>,tps_eval_root=<repo>" structural_identity.sh
...
# PBS Pro port of scripts/karolina/jobs/structural_identity.sh (calls run_structural_identity.sh).
