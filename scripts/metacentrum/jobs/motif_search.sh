...
# Usage: qsub -v "args_b64=<base64 runner args>,tps_eval_root=<repo>" motif_search.sh
...
# PBS Pro port of scripts/karolina/jobs/motif_search.sh (calls run_motif_search.sh).
...
echo "Calling run_motif_search.sh with args: $args"
sh tool_wrappers/run_motif_search.sh $args
