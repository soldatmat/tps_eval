#!/bin/bash
#PBS -N min_embedding_distance
#PBS -l walltime=00:10:00
#PBS -l select=1:ncpus=1:mem=16gb:scratch_local=2gb

# Usage: qsub -v "args_b64=<base64 runner args>,tps_eval_root=<repo>" min_embedding_distance.sh
...
# PBS Pro port of scripts/karolina/jobs/min_embedding_distance.sh (calls run_min_embedding_distance.sh).
