#!/bin/bash
#PBS -N local_sequence_search
#PBS -l walltime=04:00:00
#PBS -l select=1:ncpus=32:mem=32gb:scratch_local=20gb

# Usage: qsub -v "args_b64=<base64 runner args>,tps_eval_root=<repo>" local_sequence_search.sh
...
# PBS Pro port of scripts/karolina/jobs/local_sequence_search.sh (calls run_local_sequence_search.sh).
