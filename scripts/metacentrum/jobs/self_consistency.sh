...
# Usage: qsub -v "args_b64=<base64 runner args>,tps_eval_root=<repo>" self_consistency.sh
...
# PBS Pro port of scripts/karolina/jobs/self_consistency.sh (calls run_self_consistency.sh).
...
echo "Calling run_self_consistency.sh with args: $args"
sh tool_wrappers/run_self_consistency.sh $args
