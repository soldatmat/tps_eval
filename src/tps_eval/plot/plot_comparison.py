...
from tps_eval.plot.categorical_comparison import categorical_comparison  # noqa: E402
from tps_eval.plot.constants import (  # noqa: E402
    CATEGORICAL_TARGETS,
    STRUCTURE_CATEGORICAL,
    STRUCTURE_NUMERIC,
    TARGETS,
)
from tps_eval.plot.density_comparison import density_comparison  # noqa: E402
